...
namespace H.Win.CLI.Model
{
    ...
    {
        public static readonly string CsvHeader = $"{nameof(IP)},{nameof(CountryCode)},{nameof(CountryName)}";
        ...
        public string ToCsvLine()
            => (IP.IsEmpty()) ? null : $"{IP.Replace(",", " ")},{CountryCode?.Replace(",", " ")},{CountryName?.Replace(",", " ")}";
